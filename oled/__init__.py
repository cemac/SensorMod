...
def updatedata(date, dct):
        ...
        draw.text((x, top + 8), 'PM1 % 7s| TEMP % 4dC'%(dct[4],dct[7]), font=font, fill=255)
        draw.text((x, top + 16),'PM2.5 % 5s| RH % 6d'%(dct[5],dct[8]), font=font, fill=255)
        draw.text((x, top + 25), 'PM10 % 6s| X % 7d'%(dct[6],dct[10]), font=font, fill=255)
